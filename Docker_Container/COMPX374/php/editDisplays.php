      ...
      while($rowDisplay = $result1->fetch()) 
      {
        ...
        if($result2 != FALSE)
        {
          ...
          if($result3 != FALSE)
          {
            ...
            echo "</div>";
            echo "<button class='approve-button' id='editDisplay' type=submit' onclick='editDisplay(".$rowDisplay['display_id'].")'>Edit</button>";
            echo "<button class='disapprove-button' id='deleteDisplay' type=submit' onclick='deleteDisplay(".$rowDisplay['display_id'].")'>Delete</button>";
            echo "</div>";
          }
          else
          {
